...
const AddWorkoutScreen: React.FC<AddWorkoutScreenProps> = ({ navigation }) => {
    ...
    const handleSubmit = async (): Promise<void> => {
        ...
        if (result.success) {
            ...
            Alert.alert('Error', result.error || 'Failed to add workout');
        }
    };
    ...
    return (
        ...
        >
            ...
            >
                <View className="mb-8">
                    <Text className="text-3xl font-bold text-white mb-1">Add Workout</Text>
                    <Text className="text-sm text-text-secondary">Log your exercise details</Text>
                </View>
                ...
                {/* Submit Button */}
                <TouchableOpacity
                    className={`flex-row items-center justify-center bg-primary p-6 rounded-xl mt-6 gap-2 ${loading ? 'opacity-70' : ''}`}
                ...
                >
                    {loading ? (
                        ...
                        <>
                            ...
                            <Text className="text-base font-bold text-white">Save Workout</Text>
                        </>
                    )}
                </TouchableOpacity>
            </ScrollView>
